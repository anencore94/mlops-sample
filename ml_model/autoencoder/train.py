...
print('number of data : {}, number of Anomaly: {}'.format(len(data),
                                                          len(n_anomaly)))
print('number of train_set : {}, number of test_set : {}, shape : {}'.format(
  train_set.shape[0],
...
autoencoder = Autoencoder(hidden_dim_1=hidden_dim, hidden_dim_2=hidden_dim_2,
...
for epoch in range(1, EPOCH + 1):
  ...
  fprs, tpr, _ = metrics.roc_curve(np.array(true_label), np.array(scores),
                                   pos_label=1)
  print('Epoch : {}, Normal_recon : {}, Normal_std : {}, Abnormal_recon : {},'
        ' Abnormal_std : {}'.format(
...
print('Accuracy of Normal : {}, Accuracy of Abnormal : {}'
  .format(
